    ...
    return {
      'packageOffer': {
        ...
        'hotel': {
          ...
          'images': map_hotel_images(_.result(hotel, 'images')),
        ...
        'provider': {
          'id': 'lambda-searcher',
          'reference': result.destinationCode + result.hotelCode // JIRA ISEARCH-248
        }, // see: https://tc-jira.atlassian.net/browse/ISEARCH-248
