    ...
    return {
      ...
      'packageOffer': {
        ...
        'hotel': {
          ...
          'starRating': _.result(hotel, 'rating.guestRating') || _.result(hotel, 'rating.doubledRating'),
          'place': {
        ...
        'destinationName': result.flightInfo.outFlight.slice(-1)[0].destinationName,
